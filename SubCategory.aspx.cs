...
namespace Institute_Management
{
    public partial class SubCategory : System.Web.UI.Page
    {
        ...
        public void GetData()
        {
            ...
            from subcategories as t1
            join categories as t2 on t2.id = t1.category_id
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string query = @"insert into subcategories (name,category_id) 
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            string query = @"update subcategories set name = @name,category_id = @category_id where id = @id";
            SqlConnection con = new SqlConnection(CS);
            SqlCommand cmd = new SqlCommand(query, con);
            con.Open();
        ...
        protected void BtnEdit_Click(object sender, EventArgs e)
        {
            ...
            t1.id as id, t1.name as name, t2.id as category_id
            from subcategories as t1
            join categories as t2 on t2.id = t1.category_id
            where t1.id = '" + _id + "'";
            ...
            if (rdr.HasRows)
            {
                ...
                {
                    // Condition
                    string ch_query = @"select t1.id as id from maincategories as t1
                                        join subcategories as t2 on t2.id = t1.subcategory_id
                                        join categories as t3 on t3.id = t2.category_id
                                        where t2.category_id = '" + Convert.ToInt32(rdr["category_id"].ToString()) + "'";
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            DropDownList2.SelectedIndex = 0;
            // Condition
            string ch_query = @"select id from maincategories where subcategory_id = '" + _id + "'";
            SqlConnection con1 = new SqlConnection(CS);
            SqlCommand cmd1 = new SqlCommand(ch_query, con1);
            con1.Open();
            SqlDataReader rdr1 = cmd1.ExecuteReader();
        ...
        protected void DropDownList2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                where t1.category_id = '" + Convert.ToInt32(search) + "'";
