<%@ Page Title="SubCategory" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SubCategory.aspx.cs" Inherits="Institute_Management.SubCategory" %>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <p class="text-bold text-primary">Add SubCategory</p>
        </div>
        <div class="card-body">
            ...
            <div class="form-group">
               ...
               <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" placeholder="Input SubCategory Name"
                   ToolTip="SubCategory" required="required"></asp:TextBox>
            </div>
            ...
            <p class="text-bold text-primary form-inline mb-3">
                ...
                <span class="pull-right col-md-4">
                    <asp:TextBox ID="TextBox2" runat="server" AutoPostBack="true"
                        CssClass="form-control" Width="100%" placeholder="Search by code or SubCategory" OnTextChanged="TextBox2_TextChanged"
                        ></asp:TextBox>
                </span>
            </p>
            <br />
        ...
        <div class="card-body">
            <asp:GridView ID="GridView1" runat="server" CssClass="table GridView1" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="name" HeaderText="SubCategory" />
