<%@ Page Title="Village" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Village.aspx.cs" Inherits="Institute_Management.Village" %>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <p class="text-bold text-primary">Add Village</p>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server"
                                CssClass="form-control" ToolTip="Village" placeholder="Input Village Name"
                ...
                <div class="card">
                    <div class="card-header">
                        <p class="text-bold text-primary form-inline mb-3">
                            ...
                            <span class="pull-left col-md-3" style="width: 100%">Village List
                            </span>
                            <span class="col-md-3">
                            ...
                            <span class="pull-right col-md-3">
                                <asp:TextBox ID="TextBox2" runat="server" AutoPostBack="true"
                                    CssClass="form-control TextBox2" Width="100%" placeholder="Search by code or village" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
                            </span>
                        </p>
                        <br />
                        <br />
                        ...
                        <div class="card-body">
                            <asp:GridView ID="GridView1" runat="server" CssClass="table GridView1" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="name" HeaderText="Village" />
