<%@ Page Title="Category" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="Institute_Management.Category" %>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <p class="text-bold text-primary">Add Category</p>
        </div>
        <div class="card-body">
            ...
            <label for="text">Category:</label>
                ...
                <asp:TextBox ID="TextBox1" runat="server" 
                    CssClass="form-control" placeholder="Input Category Name"
                    ToolTip="Category"></asp:TextBox>
          </div>
            ...
            <p class="text-bold text-primary mb-3">
                ...
                <span class="pull-right">
                    <asp:TextBox ID="TextBox2" runat="server" AutoPostBack="true"
                        CssClass="form-control" placeholder="Search by code or category" OnTextChanged="TextBox2_TextChanged"
                        ></asp:TextBox>
                </span>
            </p>
            <br />
