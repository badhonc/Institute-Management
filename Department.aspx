<%@ Page Title="Department" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Department.aspx.cs" Inherits="Institute_Management.Department" %>
...
<div class="col-md-12">
    <div class="card">
        <div class="card-header">
            <p class="text-bold text-primary">Add Department</p>
        </div>
        <div class="card-body">
            ...
            <label for="text">Department:</label>
                ...
                <asp:TextBox ID="TextBox1" runat="server" 
                    CssClass="form-control" placeholder="Input Department Name"
                    ToolTip="Department"></asp:TextBox>
          </div>
            ...
            <p class="text-bold text-primary mb-3">
                ...
                <span class="pull-right">
                    <asp:TextBox ID="TextBox2" runat="server" AutoPostBack="true"
                        CssClass="form-control" placeholder="Search Department" OnTextChanged="TextBox2_TextChanged"
                        ></asp:TextBox>
                </span>
            </p>
            <br />
