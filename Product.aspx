<%@ Page Title="Product" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Product.aspx.cs" Inherits="Institute_Management.Product" %>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <p class="text-bold text-primary">Add Product</p>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <asp:GridView ID="GridView1" runat="server" CssClass="table GridView1" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Nai">
                                        <FooterTemplate>
